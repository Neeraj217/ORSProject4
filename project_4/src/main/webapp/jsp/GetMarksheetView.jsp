	...
	<center>
      ...
      <h2>
		...
		<form action="<%=ORSView.GET_MARKSHEET_CTL%>" method="post">
			...
			<table>
			<tr>
				<label align="left">Roll No :<font color="red">*</font></label>&emsp;
				...
				<td style ="position:fixed"> <font color="red" style="position: relative; left: 170px; top: -23px;"> <%=ServletUtility.getErrorMessage("rollNo", request)%></font></td>
              </tr>   
				<% 
				if(bean!=null){
				...
				<table border="1px "  style="width:100%">
					<tr  >
						...
						<th colspan="8">Roll No : <%=bean.getRollNo() %></th>
					</tr>
					<tr>
