            ...
            <table  align="center" style="margin-left: 38%;">
                <tr >
                    ...
                    <td><input type="text" name="login"
                        ...
                        </td><td><font color="red"> <%=ServletUtility.getErrorMessage("login", request)%></font></td>
                </tr>
               ...
               <tr style="margin-top: 2%">
					...
					<td><input type="text" name="dob" placeholder="(MM/dd/yyyy)" value="<%=DataUtility.getDateString(bean.getDob())%>"  id="date" readonly>
