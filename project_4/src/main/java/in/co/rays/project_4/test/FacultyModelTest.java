...
public class FacultyModelTest {
	 ...
	 */
	public static void main(String[] args) throws ParseException, SQLException, DuplicateRecordException {
	//testAdd();
		//testDelete();
	//	testUpdate();
		//testFindByEmaiId();
	 ...
	 * @throws DuplicateRecordsException 
	 */
	public static void testAdd() throws ParseException, DuplicateRecordException, SQLException{
