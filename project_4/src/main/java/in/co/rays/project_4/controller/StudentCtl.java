...
public class StudentCtl extends BaseCtl {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("StudentCtl Method doGet Ended");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (OP_SAVE.equalsIgnoreCase(op)|| OP_UPDATE.equalsIgnoreCase(op)) {
			...
			try {
				...
				if (id > 0) {
					model.update(bean);
					System.out.println("kkkkkkkkkkkk id"+bean.getId()+"name  "+bean.getCollegeName()+"  first name last name  "+bean.getFirstName()+bean.getLastName()+"--------------------"+bean.getMobileNo());
					ServletUtility.setBean(bean, request);
					ServletUtility.setSuccessMessage("data is added successfully Updated", request);
					System.out.println("yaha ruk rha hai");
				} else {
					System.out.println("StudentCtl do post in else");
					long pk=0;
					System.out.println("yaha");
					 pk = model.add(bean);
					System.out.println("yaha ruka");
